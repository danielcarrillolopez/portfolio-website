    ...
    <main className="min-h-screen bg-background dark:bg-background-dark">
      ...
      <section className="relative overflow-hidden px-4 py-24 md:py-32">
        ...
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          <FadeIn>
            <div className="inline-block mb-6 px-4 py-1.5 bg-primary/10 dark:bg-primary-dark/10 rounded-full border border-primary/20 dark:border-primary-dark/20">
          ...
          {featuredProjects.map((project, index) => (
            <FadeIn key={project.id} delay={index * 0.1}>
              <Link
                ...
                className="block bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
              >
