  ...
  const mentors = [
    {
      ...
      image: "/images/profile/profile.jpg", // Placeholder
      ...
      links: [
        { label: "CHROME Lab", url: "https://www.chromelab.slu.edu/" }
      ]
    },
    {
      name: "Jake Little",
    ...
    },
    {
      ...
      links: [
        { label: "Rockwood PIE", url: "https://www.rsdmo.org/departments/partners-in-education" }
      ]
    }
  ];
