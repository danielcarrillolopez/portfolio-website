        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {visibleMentors.map((mentor, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-md transition-shadow h-full">
